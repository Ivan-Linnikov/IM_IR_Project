...
def filter_json_by_location_day_and_time(location_keyword='', day_of_week='', input_time=''):
    input_file_path = 'data_ex.json'
    output_file_path = 'filtered_data_ex.json'
    """
...
filter_json_by_location_day_and_time('Zurich', 'Friday', '10:00')  # Filter by location, day, and time
